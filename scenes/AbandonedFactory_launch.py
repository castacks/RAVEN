...
ENV_URL = "/isaac-sim/AirStack/scenes/AbandonedFactoryExport.usd"
STAGE_SCALE = 1.0
...
#Drone offset
SPAWN_HEIGHT_ABOVE_FLOOR_M = 1.75

DRONE1_XY_M = (16.81, -12.9)

SPAWN_HEIGHT_ABOVE_FLOOR_M = 0.01

DRONE1_XY_M = (16.81, -2.8)
# ---------------------------------------------------------
...
class PegasusApp:
    ...
    def run(self):
        # Main loop — mirrors example_one: reset once on first play, then step
